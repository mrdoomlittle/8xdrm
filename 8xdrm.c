...
mdl_u8_t _1l_msb = 0x80;
mdl_u8_t _2l_msb = 0xC0;
mdl_u8_t _3l_msb = 0xE0;
mdl_u8_t _4l_msb = 0xF0;
mdl_u8_t _5l_msb = 0xF8;
mdl_u8_t _6l_msb = 0xFC;
mdl_u8_t _7l_msb = 0xFE;

mdl_u8_t static cpy_bits(mdl_u8_t __byte, mdl_u8_t __bit_c) {
	mdl_u8_t ret_val = 0;
	switch(__bit_c) {
		case 0: return 0;
		case 1: ret_val = __byte&_1l_msb; break;
		case 2: ret_val = __byte&_2l_msb; break;
		case 3: ret_val = __byte&_3l_msb; break;
		case 4: ret_val = __byte&_4l_msb; break;
		case 5: ret_val = __byte&_5l_msb; break;
		case 6: ret_val = __byte&_6l_msb; break;
		case 7: ret_val = __byte&_7l_msb; break;
		default:
			return (mdl_u8_t)~0;
	}
	return ret_val;
...
void _8xdrm_put_lx(struct _8xdrm *__8xdrm, mdl_u8_t __data, mdl_u8_t __w) {
	if (__8xdrm->bits_needed < __w) {
		...
		_8xdrm_put_lx(__8xdrm, __data, e);
	} else {
		__8xdrm->byte_out |= (__data << 8-__w) >> 8-__8xdrm->bits_needed;
...
mdl_u8_t _8xdrm_get_lx(struct _8xdrm *__8xdrm, mdl_u8_t __w) {
	mdl_u8_t ret_val = 0;
	...
	if (__8xdrm->has_leftovers) {
		...
		return _8xdrm_get_lx(__8xdrm, __w);
	}
